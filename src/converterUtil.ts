...
export class ConverterUtil {
  ...
  convertToWords(value: number | null): Array<string> {
  ...
  convertSubHundredToWords(value: number): Array<string> {
  ...
  convertDecimalToWords(decimal: string): Array<string> {
